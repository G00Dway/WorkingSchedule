            ...
            <div className={style.loginContainer}>
                <div className={style.loginContent}>
                    ...
                    <form className={style.loginForm}>
                        <input type="email" placeholder="Email (misal: manager@gmail.com)" className={style.inputField} />
                        ...
                        <input type="passwordsubmit" placeholder="Parolu yenidən yazın" className={style.inputField} />
                        <button type="submit" className={style.loginButton}>Qeydiyyat</button>
                        <Link to={"/login"}>Giriş'ə geri qayıt</Link>
                    </form>
                </div>
            </div>
        </div>
